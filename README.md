...
Per automatizzare l'esecuzione di ogni modulo, e quindi dell'intero framework, bisogna fare riferimento al file "run_full_workflow.sh", il quale è in grado di eseguire tutti i moduli insieme e portare l'utente a visualizzare subito i risultati. 
...
```
Successivamente, lanciarlo con il seguente comando:
```bash
